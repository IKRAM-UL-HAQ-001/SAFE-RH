...
class paramedicDateScreen extends StatefulWidget {
final docid;
final slots;
final date;
final patientId;
const paramedicDateScreen({this.docid, this.slots, this.date,this.patientId});
  @override
  State<paramedicDateScreen> createState() => _paramedicDateScreenState();
}

class _paramedicDateScreenState extends State<paramedicDateScreen> {
  @override
  void initState() {
    print(jo);
