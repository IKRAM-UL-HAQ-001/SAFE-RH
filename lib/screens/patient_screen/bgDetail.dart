...
class bgDetailPage extends StatefulWidget {
  const bgDetailPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _bgDetailPageState createState() => _bgDetailPageState();
}

class _bgDetailPageState extends State<bgDetailPage> {
  var loading = true;
  var showTable = false;
  ...
  void getAll() async {
    ...
    print(body);
    try {
      var url = Uri.parse("https://safe-rh-mis.com/vitals/$keyUserID/12");
      print(url);
