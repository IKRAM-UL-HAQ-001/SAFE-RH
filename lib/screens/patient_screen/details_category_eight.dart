...
class DetailsCategoryEight extends StatefulWidget {

  final Id;
  final Date;
  DetailsCategoryEight({this.Id,this.Date});
  @override
  State<DetailsCategoryEight> createState() => _DetailsCategoryEightState();
}
class _DetailsCategoryEightState extends State<DetailsCategoryEight> {
  var test=[];
  var loading=true;
  var detaillist = [];
  var final_array =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Description",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),centerTitle: true,backgroundColor: Colors.white,automaticallyImplyLeading: false,),
        body:loading?
        Column(
