...
class DetailsCategoryFour extends StatefulWidget {

  final Id;
  final Date;
  DetailsCategoryFour({this.Id,this.Date});
  @override
  State<DetailsCategoryFour> createState() => _DetailsCategoryFourState();
}
class _DetailsCategoryFourState extends State<DetailsCategoryFour> {
  var test=[];
  var loading=true;
  var detaillist = [];
  var final_array =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Prescription Detail",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),centerTitle: true,backgroundColor: Colors.white,automaticallyImplyLeading: false,),
        body:loading?
        Column(
