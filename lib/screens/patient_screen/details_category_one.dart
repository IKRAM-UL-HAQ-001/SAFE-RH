...
class DetailsCategoryOne extends StatefulWidget {

  final Id;
  final Date;
  DetailsCategoryOne({this.Id,this.Date});
  @override
  State<DetailsCategoryOne> createState() => _DetailsCategoryOneState();
}
class _DetailsCategoryOneState extends State<DetailsCategoryOne> {
  var test=[];
  var loading=true;
  var detaillist = [];
  var final_array =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("GPE Detail",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),centerTitle: true,backgroundColor: Colors.white,automaticallyImplyLeading: false,),
        body: loading?
        Column(
