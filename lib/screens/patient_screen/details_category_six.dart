...
class DetailsCategorySix extends StatefulWidget {

  final Id;
  final Date;
  DetailsCategorySix({this.Id,this.Date});
  @override
  State<DetailsCategorySix> createState() => _DetailsCategorySixState();
}
class _DetailsCategorySixState extends State<DetailsCategorySix> {
  var test=[];
  var loading=true;
  var detaillist = [];
  var final_array =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Past History Detail",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),centerTitle: true,backgroundColor: Colors.white,automaticallyImplyLeading: false,),
        body:loading?
        Column(
