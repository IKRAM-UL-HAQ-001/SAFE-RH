...
class DetailsCategoryThree extends StatefulWidget {

  final Id;
  final Date;
  DetailsCategoryThree({this.Id,this.Date});
  @override
  State<DetailsCategoryThree> createState() => _DetailsCategoryThreeState();
}
class _DetailsCategoryThreeState extends State<DetailsCategoryThree> {
  var test=[];
  // var testName;
  var detaillist = [];
  var final_array =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Test Detail",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),centerTitle: true,backgroundColor: Colors.white,automaticallyImplyLeading: false,),
        body:Column(
          children: [
            Expanded(
              child: Row(
