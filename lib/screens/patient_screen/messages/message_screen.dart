// ignore_for_file: deprecated_member_use, unnecessary_null_comparison, unused_element, unused_local_variable, override_on_non_overriding_member
import 'dart:async';
...
class MessagesScreen extends StatefulWidget {
  final doctorid;
  final appointid;
  MessagesScreen({this.doctorid, this.appointid});
  @override
...
class _MessagesScreenState extends State<MessagesScreen> {
                        ...
                        Card(
                            ...
                            child: InkWell(
                              child: ListTile(
                                ...
                                title:
                                (sendrealdata[index]["message"].length > 5) ?
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    : Text(
                                  "${sendrealdata[index]['message']}",
                                  textAlign: sendrealdata[index]['id'] == 1
                                      ? TextAlign.left
                                      : TextAlign.right,
                                  style: TextStyle(
                                      color: Colors.black,
                                ...
                                subtitle: Text("${sendrealdata[index]['time']}",
                                  textAlign: sendrealdata[index]['id'] == 1
                                      ? TextAlign.left
                                      : TextAlign.right,
                                  style: TextStyle(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  if (textmsg != '') {
                                    messageDataPost(
                                        textmsg.text.toString(), appointId,
                                        doctorId);
                                  }
                                },
                              ),
  ...
  void initState() {
    timer = Timer.periodic(Duration(seconds: 1), (Timer t) => realmessageDataget());
    super.initState();
  }
