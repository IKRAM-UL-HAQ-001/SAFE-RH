import 'dart:convert';
// "Oxygen Saturation",
// var url = Uri.parse("https://safe-rh-mis.com/vitals/$keyUserID/2");
...
class spO2DetailPage extends StatefulWidget {
  const spO2DetailPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _spO2DetailPageState createState() => _spO2DetailPageState();
}

class _spO2DetailPageState extends State<spO2DetailPage> {
  var loading = true;
  var showTable = false;
